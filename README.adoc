...
* an extensible link:chap-asset-model.html[Domain Model] with common asset types like link:chap-web-page.html[web pages], link:chap-web-articles.html[articles] and link:chap-redirects.html[redirects] <<Redirects-overview,redirects>>
* a way to manage the link:chap-endpoint-url.html[URLs for these assets]. 
