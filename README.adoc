...
* an extensible link:/content/chap-asset-model.html[Domain Model] with common asset types like <<WebCmsPage-overview,web pages>>, <<PublicationModel-overview,articles>> and <<Redirects-overview,redirects>>
