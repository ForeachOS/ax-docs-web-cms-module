...
* an extensible link:../chap-asset-model[Domain Model] with common asset types like <<WebCmsPage-overview,web pages>>, <<PublicationModel-overview,articles>> and <<Redirects-overview,redirects>>
