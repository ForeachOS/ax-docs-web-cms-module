...
== Default data
{module-name} installs some default assets and types when starting for the first time.
...
=== Default types
_classpath:installers/WebCmsModule/default-types.yml_
...
=== Default assets
_classpath:installers/WebCmsModule/default-assets.yml_
