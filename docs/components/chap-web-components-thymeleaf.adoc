[[components-thymeleaf-integration]]
...
Markup components can render placeholders by using link:chap-web-components-content-markers.adoc#placeholder-content-markers[placeholder content markers].
...
Like with placeholders, a markup component can include other components using link:chap-web-components-content-markers.adoc#component-content-markers[component content markers].
...
Where a markup component uses a link:chap-web-components-content-markers.adoc#placeholder-content-markers[placeholder content markers] to render the placeholder content, a `ContainerWebCmsComponentModel` will get a member component of type `PlaceholderWebCmsComponentModel` instead.
