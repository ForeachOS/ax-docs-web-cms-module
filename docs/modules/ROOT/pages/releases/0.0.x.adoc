...
* Name, source, description and keywords where added to a WebCmsImage
* You can now also search for images using source, description and keywords that where provided.
