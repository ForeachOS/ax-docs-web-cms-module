...
The [Thymeleaf dialect](/docs/appendices/thymeleaf-dialect.adoc) has the **\#wcm** expression object to easily generate the url for a `WebCmsImage` in your Thymeleaf template.
