...
The data import services are also the ones used for the default data of {{book.moduleName}}, see the link:../appendices/appendix-default-data.adoc#appendix-default-data[appendix] for the YAML version of the default types and assets.
...
* link:../menu/chap-menu.adoc#WebCmsMenu-import[importing menus]
* link:../components/chap-web-components.adoc#WebCmsComponent-import[importing web components]
* link:../pages/chap-web-page.adoc#WebCmsPage-import[importing pages]
* link:../publication/chap-publication-model.adoc#WebCmsArticle-import[importing publications and articles]
...
See link:../pages/chap-web-page.adoc#WebCmsPage-import[page importing] for examples.
