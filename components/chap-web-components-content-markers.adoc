...
Default rendering support is available for Thymeleaf templates, see the <<thymeleaf-content-markers,{{book.moduleName}} Thymeleaf dialect>>.
...
See <<thymeleaf-content-markers,{{book.moduleName}} Thymeleaf dialect>> on how to add content marker support for component rendering.
